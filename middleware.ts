...
const allowedOrigins = [
  process.env.NEXTAUTH_URL || "https://rggoldenpalace.com",
  process.env.NEXT_PUBLIC_API_URL || "https://rggoldenpalace.com",
  "http://localhost:3000",
];
  ...
  try {
    ...
    if (pathname.startsWith("/api/")) {
      ...
      if (
        ...
        pathname.startsWith("/api/verify-email-change") ||
        pathname.startsWith("/api/resend-email-verification")
      ) {
        return NextResponse.next();
      }
