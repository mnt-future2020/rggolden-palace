            ...
            <div className="grid grid-cols-12 gap-6 items-center">
              ...
              <div className="col-span-9">
                <div className="flex gap-3 items-center max-w-md">
                  <Input
                    ...
                    value={
                      formData.logo instanceof File
                        ? formData.logo.name
                        : formData.logo || "No file selected"
                    }
                    variant="bordered"
                    radius="lg"
                    className="flex-1"
                  ...
                  <Button
                    color="primary"
                    className="bg-hotel-primary text-white px-6"
                    radius="lg"
                    onPress={() =>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-12 gap-6 items-start">
              ...
              <div className="col-span-9">
                <div className="relative max-w-md" ref={categoryInputRef}>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <Button
                                size="sm"
                                isIconOnly
                                className="bg-transparent hover:bg-gray-200 text-red-500"
                                onPress={(e) => {
            ...
            <div className="grid grid-cols-12 gap-6 items-start">
              ...
              <div className="col-span-9">
                <div className="relative max-w-md" ref={expenseInputRef}>
                  <div className="flex gap-3">
                    <Input
            ...
            <div className="col-span-9">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-600">
                  Enable manual financial year control
                </span>
              </div>
            </div>
          </div>
