...
export const LogoIcon = ({ hotelData }) => {
  ...
  return (
    <Link
      href={`/dashboard`}
      className="logo-container h-16 flex items-center justify-center transition-all duration-300 w-full"
    >
      <div className="logo-wrapper relative w-10 h-10 flex items-center justify-center">
