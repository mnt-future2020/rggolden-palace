        ...
        case "paidAmount":
          return (
            <div className="font-bold text-green-500">
              {contact.paidAmount ? formatCurrency(contact.paidAmount) : "₹0"}
            </div>
          );
        case "paymentReceipt":
          return contact.paymentReceipt ? (
            <a
              href={contact.paymentReceipt}
              target="_blank"
              rel="noopener noreferrer"
              className="text-hotel-primary hover:underline flex items-center gap-1"
            >
              <Download size={16} />
              View
            </a>
